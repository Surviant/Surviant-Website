...
export default function InteractiveCard({
  ...
  if (isMobile || isTouchDevice) {
    return (
      <motion.div
        className={cn(
          "relative overflow-hidden rounded-xl bg-white border border-slate-200 shadow-sm hover:shadow-lg transition-all duration-300",
          className,
        )}
        initial="initial"
        whileHover="hover"
  ...
  return (
    <motion.div
      ref={cardRef}
      className={cn(
        "relative overflow-hidden rounded-xl bg-white border border-slate-200 shadow-md hover:shadow-xl transition-all duration-300",
        mouseOver && "border-blue-500",
        className,
      )}
      style={{
