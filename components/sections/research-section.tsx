      ...
      >
        ...
        <motion.div variants={itemVariants} className="text-center space-y-4 sm:space-y-6 md:space-y-8">
          <div className="inline-block">
            <span className="inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full border border-blue-500/30 bg-blue-50 text-blue-600 text-xs sm:text-sm font-medium mb-4 sm:mb-6">
          ...
          <h2 className="text-2xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold leading-tight px-2">
            ...
            <br />
            <span className="text-slate-900 text-xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl">at the Edge of Possibility</span>
          </h2>
          <p className="text-sm sm:text-base md:text-lg lg:text-xl text-slate-600 max-w-4xl mx-auto leading-relaxed px-2">
            Pushing the boundaries of{" "}
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-cyan-500 font-semibold">
              technology
            </span>,{" "}
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-cyan-500 font-semibold">
        ...
        <motion.div variants={itemVariants} className="grid grid-cols-3 gap-3 sm:gap-4 md:gap-6">
          {stats.map((stat, index) => {
            ...
            return (
              <motion.div
                key={index}
                className="relative p-3 sm:p-5 md:p-8 rounded-xl sm:rounded-2xl border border-slate-200 bg-white shadow-md text-center group hover:border-blue-500 hover:shadow-lg transition-all duration-300"
                whileHover={{ y: -5, scale: 1.02 }}
              >
                <div className="absolute inset-0 bg-gradient-to-br from-blue-500/5 to-cyan-500/5 opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-xl sm:rounded-2xl" />
                <div className="relative z-10">
                  <Icon className="h-5 w-5 sm:h-6 sm:w-6 md:h-8 md:w-8 mx-auto mb-2 sm:mb-3 md:mb-4 text-blue-500" />
                  <div className="text-xl sm:text-2xl md:text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-cyan-500 mb-1 sm:mb-2">
                    {stat.value}
                  </div>
                  <div className="text-slate-600 text-[10px] sm:text-xs md:text-sm font-medium">{stat.label}</div>
                </div>
              </motion.div>
            )
          })}
            ...
            {researchAreas.map((area, index) => {
              ...
              const cardContent = (
                <motion.div
                  ...
                  className="group relative bg-white border border-slate-200 shadow-md rounded-2xl sm:rounded-3xl p-4 sm:p-6 md:p-8 lg:p-10 hover:border-blue-500 hover:shadow-xl transition-all duration-300 cursor-pointer"
                ...
                >
                  ...
                  <div className="relative z-10 space-y-3 sm:space-y-4 md:space-y-6">
                    {/* Icon */}
                    <div className="inline-flex p-3 sm:p-4 md:p-5 rounded-xl sm:rounded-2xl bg-gradient-to-br from-blue-500 to-cyan-500 shadow-lg shadow-blue-500/20 group-hover:shadow-blue-500/40 transition-all duration-300">
                      <Icon className="h-6 w-6 sm:h-8 sm:w-8 md:h-10 md:w-10 text-white" />
                    </div>

                    {/* Content */}
                    <div>
                      <h3 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold mb-2 sm:mb-3 md:mb-4 text-slate-900 group-hover:bg-clip-text group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:from-blue-600 group-hover:to-cyan-600 transition-all duration-300 flex items-center gap-2">
                        {area.title}
                      ...
                      <p className="text-slate-600 leading-relaxed text-xs sm:text-sm md:text-base lg:text-lg mb-3 sm:mb-4 md:mb-6 line-clamp-3 sm:line-clamp-none">
                        {area.description}
                      </p>
                    </div>
                  ...
                  <div className="absolute top-0 right-0 w-20 sm:w-40 h-20 sm:h-40 bg-gradient-to-br from-blue-500/10 to-cyan-500/10 opacity-0 rounded-2xl sm:rounded-3xl blur-3xl group-hover:opacity-100 transition-opacity duration-300" />
                </motion.div>
              )
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 sm:gap-4 md:gap-6">
            {publications.map((pub, index) => (
              <motion.div
                key={index}
                variants={itemVariants}
                className="p-4 sm:p-5 md:p-6 rounded-xl sm:rounded-2xl border border-slate-200 bg-white shadow-md hover:border-blue-500 hover:shadow-lg transition-all duration-300 group relative"
                whileHover={{ y: -5 }}
              >
                <div className="absolute inset-0 bg-gradient-to-br from-blue-500/5 to-cyan-500/5 opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-xl sm:rounded-2xl" />
                <div className="relative z-10">
                  <Code className="h-5 w-5 sm:h-6 sm:w-6 text-blue-500 mb-2 sm:mb-3 md:mb-4" />
                  <h4 className="text-sm sm:text-base md:text-lg font-bold text-slate-900 mb-1 sm:mb-2 group-hover:text-blue-600 transition-colors line-clamp-2">
                    {pub.title}
                  </h4>
